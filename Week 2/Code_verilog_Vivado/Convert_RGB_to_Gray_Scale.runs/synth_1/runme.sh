...
HD_PWD='E:/Hoc_Tap/Nam_3_Ki_2/Chuyen_De_Thiet_Ke_Vi_Mach_1/Exercises/Week_2/Convert_RGB_to_Gray_Scale/Convert_RGB_to_Gray_Scale.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Convert_RGB_To_Gray_Scale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Convert_RGB_To_Gray_Scale.tcl
